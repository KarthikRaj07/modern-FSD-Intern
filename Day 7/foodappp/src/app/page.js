...
import SlideCrousel from '../food-web/components/SlideCrousel';
import GridCard from '../food-web/components/GridCard';
import Link from 'next/link';

import Foods from '../food-web/components/foods.json';
